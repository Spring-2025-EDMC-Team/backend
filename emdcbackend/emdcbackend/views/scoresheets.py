...
def create_sheets_for_teams_in_cluster(judge_id, cluster_id, presentation, journal, mdo, runpenalties, otherpenalties, redesign):
    try:
...
def delete_sheets_for_teams_in_cluster(judge_id, cluster_id,  presentation, journal, mdo,runpenalties, otherpenalties, redesign):
    try:
        # Fetch all mappings for the teams in the cluster
        mappings = MapClusterToTeam.objects.filter(clusterid=cluster_id)
...
def get_scoresheet_details_for_contest(request):
    ...
    for mapping in team_mappings:
        ...
        championship_scoresheet_response = {
            "1":championship_scoresheet_response[0],
            "2": championship_scoresheet_response[1],
            "3": championship_scoresheet_response[2],
            "4": championship_scoresheet_response[3],
            "5": championship_scoresheet_response[4],
            "6": championship_scoresheet_response[5],
            "7": championship_scoresheet_response[6],
            "8": championship_scoresheet_response[7],
            "9": championship_scoresheet_response[8],
